        ...
        <div className="container">
          ...
          <div className="services__items">
            <ServicesSectionItem
              ...
              desc="I build responsive, high-performance websites using JavaScript, React, Node, HTML, CSS, and Tailwind, designed to meet your specific needs."
            />
            
            <ServicesSectionItem
              icon={<MdCode />}
              title="Code Support"
              desc="I offer expert code support, assisting with debugging, optimization, and clean, efficient development."
            />
          </div>
        </div>
      </div>
